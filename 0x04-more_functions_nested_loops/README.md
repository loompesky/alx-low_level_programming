General: An introductory project on:

Nested loops and how to use them Functions and how to use them The difference between a declaration and a definition of a function prototypes Scope of variables Header files and how to to use them with #include Requirements: Ubuntu 14.04 gcc 4.8.4 No standard library functions Allowed to use putchar Tasks: Mandatory 0-isupper.c - function that checks for uppercase character.
...
Advanced 100-prime_factor.c - finds and prints the largest prime factor of the number 612852475143, followed by a new line.
